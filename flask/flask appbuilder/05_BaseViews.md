...
- Develop your template (on your "PROJECT_NAME"/app/templates/method3.html):
...
- Add the following method on your MyView class:
...
appbuilder.add_view(MyFormView, "My form View", icon="fa-group", label=_('My form 
    View'), category="My Forms", category_icon="fa-cogs")
```
