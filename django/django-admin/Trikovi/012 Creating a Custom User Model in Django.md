...
**Remember**: You must create the custom user model before you apply your first migration.
...
If you went the `AbstractBaseUser` route, you wont have fields for `first_name` or `last_name`. Why?
